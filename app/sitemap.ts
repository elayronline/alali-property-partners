...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/hmo-sourcing`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${baseUrl}/development-management`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
